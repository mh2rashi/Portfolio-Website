...
>
   <div name="contact" class="flex flex-col w-full mx-auto max-w-[600px] justify-center">
    ...
    <div class="pb-4 justify-center place-items-center">
   
        <p class="font-semibold text-3xl sm:text-4xl md:text-5xl poppins text-cyan-400 text-center">Contact <span class="font-semibold text-3xl sm:text-4xl md:text-5xl poppins text-white text-center">me.</span></p>
        <p class="text-large sm:text-xl md:text-2xl text-center">Submit the form below to get in touch with me.</p>
